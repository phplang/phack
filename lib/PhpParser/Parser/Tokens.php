...
final class Tokens
{
    ...
    const T_ENUM = 265;
    const T_LOGICAL_OR = 266;
    const T_LOGICAL_XOR = 267;
    const T_LOGICAL_AND = 268;
    const T_PRINT = 269;
    const T_YIELD = 270;
    const T_DOUBLE_ARROW = 271;
    const T_YIELD_FROM = 272;
    const T_PLUS_EQUAL = 273;
    const T_MINUS_EQUAL = 274;
    const T_MUL_EQUAL = 275;
    const T_DIV_EQUAL = 276;
    const T_CONCAT_EQUAL = 277;
    const T_MOD_EQUAL = 278;
    const T_AND_EQUAL = 279;
    const T_OR_EQUAL = 280;
    const T_XOR_EQUAL = 281;
    const T_SL_EQUAL = 282;
    const T_SR_EQUAL = 283;
    const T_POW_EQUAL = 284;
    const T_COALESCE = 285;
    const T_BOOLEAN_OR = 286;
    const T_BOOLEAN_AND = 287;
    ...
    const T_CHARACTER = 322;
    const T_BAD_CHARACTER = 323;
    const T_ENCAPSED_AND_WHITESPACE = 324;
    const T_CONSTANT_ENCAPSED_STRING = 325;
    const T_ECHO = 326;
    const T_DO = 327;
    const T_WHILE = 328;
    ...
    const T_DEFAULT = 340;
    const T_BREAK = 341;
    const T_CONTINUE = 342;
    const T_GOTO = 343;
    const T_FUNCTION = 344;
    const T_CONST = 345;
    const T_RETURN = 346;
    const T_TRY = 347;
    const T_CATCH = 348;
    ...
    const T_THROW = 350;
    const T_USE = 351;
    const T_INSTEADOF = 352;
    const T_GLOBAL = 353;
    const T_STATIC = 354;
    const T_ABSTRACT = 355;
    const T_FINAL = 356;
    const T_PRIVATE = 357;
    const T_PROTECTED = 358;
    const T_PUBLIC = 359;
    const T_VAR = 360;
    const T_UNSET = 361;
    const T_ISSET = 362;
